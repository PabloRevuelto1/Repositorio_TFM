...
| **[03 — Respuestas a dudas concretas](03_Respuestas_dudas.md)** | Siete dudas puntuales del doc 01: campo de desplazamientos, efecto Poisson, Euler-Bernoulli, elastodinámica lineal/tensión plana, deformación angular y cortante, interpretación física de σ_xx/σ_yy/τ_xy, y umbrales de Von Mises. |
