...
w_{\mathrm{ic}}=1,\ w_{\mathrm{eq}}=20$. El balance es **crítico**: dar a la carga su
propio peso (alto), usar restricciones duras **y** el equilibrio seccional evita que la
red colapse a $u=v=0$ (ver §12).
...
> ingeniería de verdad. *(Estado: equilibrio seccional implementado y validado con lotes
> pequeños; pendiente el reentreno de confirmación en RunPod.)*
