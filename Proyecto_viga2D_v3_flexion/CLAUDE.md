...
- **Restricciones duras**: la salida se multiplica por `ξ · t̂²/(t̂²+τ²)` (cero en
  empotramiento ξ=0 e inicial t̂=0; SATURA a 1, no crece) → evita el colapso trivial.
...
`w_res=1, w_load=20, w_bc=5, w_ic=1, w_eq=20`. **`w_eq` = EQUILIBRIO SECCIONAL**
